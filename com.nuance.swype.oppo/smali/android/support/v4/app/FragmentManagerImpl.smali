...
# static fields
.field private static DECELERATE_CUBIC:Landroid/view/animation/Interpolator;

.field private static DECELERATE_QUINT:Landroid/view/animation/Interpolator;

.field private static HONEYCOMB:Z
...
.field private mAvailBackStackIndices:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field private mAvailIndices:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field private mBackStack:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field private mBackStackIndices:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field private mTmpActions:[Ljava/lang/Runnable;
...
.method private getFragment(Landroid/os/Bundle;Ljava/lang/String;)Landroid/support/v4/app/Fragment;
    .locals 5
...
.method private loadAnimation(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
    ...
    invoke-static {}, Landroid/support/v4/app/Fragment;->onCreateAnimation$24236ca7()Landroid/view/animation/Animation;
    ...
    iget p4, v2, Landroid/view/WindowManager$LayoutParams;->windowAnimations:I
    ...
    invoke-static {v2, v5, v6, v5}, Landroid/support/v4/app/FragmentManagerImpl;->makeOpenCloseAnimation$376f30fd(FFFF)Landroid/view/animation/Animation;
    ...
    invoke-static {v5, v7, v5, v6}, Landroid/support/v4/app/FragmentManagerImpl;->makeOpenCloseAnimation$376f30fd(FFFF)Landroid/view/animation/Animation;
    ...
    invoke-static {v7, v5, v6, v5}, Landroid/support/v4/app/FragmentManagerImpl;->makeOpenCloseAnimation$376f30fd(FFFF)Landroid/view/animation/Animation;
    ...
    invoke-static {v5, v2, v5, v6}, Landroid/support/v4/app/FragmentManagerImpl;->makeOpenCloseAnimation$376f30fd(FFFF)Landroid/view/animation/Animation;
    ...
    invoke-static {v6, v5}, Landroid/support/v4/app/FragmentManagerImpl;->makeFadeAnimation$424ea1bd(FF)Landroid/view/animation/Animation;
    ...
    invoke-static {v5, v6}, Landroid/support/v4/app/FragmentManagerImpl;->makeFadeAnimation$424ea1bd(FF)Landroid/view/animation/Animation;
...
.method private moveToState$2563266(I)V
    .locals 1
    .param p1, "newState"    # I
...
.method private startPendingDeferredFragments()V
    ...
    .line 1128
    iget-boolean v0, v1, Landroid/support/v4/app/Fragment;->mDeferStart:Z
    ...
    .line 1128
    :cond_3
    iput-boolean v3, v1, Landroid/support/v4/app/Fragment;->mDeferStart:Z
...
.method public final dispatchActivityCreated()V
    ...
    invoke-direct {p0, v0}, Landroid/support/v4/app/FragmentManagerImpl;->moveToState$2563266(I)V
...
.method public final enqueueAction$574583f(Ljava/lang/Runnable;)V
    .locals 2
...
.method public final execPendingActions()Z
    ...
    .line 1484
    invoke-direct {p0}, Landroid/support/v4/app/FragmentManagerImpl;->startPendingDeferredFragments()V
...
.method public final hideFragment(Landroid/support/v4/app/Fragment;II)V
    ...
    .line 1219
    invoke-static {}, Landroid/support/v4/app/Fragment;->onHiddenChanged$1385ff()V
...
.method final moveToState(Landroid/support/v4/app/Fragment;IIIZ)V
    ...
    invoke-direct {p0, v0, v1}, Landroid/support/v4/app/FragmentManagerImpl;->getFragment(Landroid/os/Bundle;Ljava/lang/String;)Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {p1}, Landroid/support/v4/app/Fragment;->onAttach$63a22f9()V
    ...
    invoke-static {}, Landroid/support/v4/app/FragmentActivity;->onAttachFragment$65850823()V
    ...
    invoke-virtual {p1}, Landroid/support/v4/app/Fragment;->getLayoutInflater$2ee30c11()Landroid/view/LayoutInflater;

    iget-object v0, p1, Landroid/support/v4/app/Fragment;->mSavedFragmentState:Landroid/os/Bundle;

    invoke-virtual {p1}, Landroid/support/v4/app/Fragment;->performCreateView$469ccb8a()Landroid/view/View;
    ...
    invoke-static {}, Landroid/support/v4/app/Fragment;->onViewCreated$65f1d89()V
    ...
    iget-object v2, v0, Landroid/support/v4/app/FragmentContainer;->this$0:Landroid/support/v4/app/Fragment;
    ...
    :cond_10
    iget-object v0, v0, Landroid/support/v4/app/FragmentContainer;->this$0:Landroid/support/v4/app/Fragment;
    ...
    invoke-direct {p0, p1, p3, v0, p4}, Landroid/support/v4/app/FragmentManagerImpl;->loadAnimation(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
    ...
    invoke-virtual {p1}, Landroid/support/v4/app/Fragment;->performActivityCreated$79e5e33f()V
    ...
    invoke-virtual {p1}, Landroid/support/v4/app/Fragment;->restoreViewState$79e5e33f()V
...
.method public final popBackStackImmediate()Z
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/BackStackRecord;->popFromBackStack$1385ff()V
...
.method final restoreAllState(Landroid/os/Parcelable;Ljava/util/ArrayList;)V
    ...
    .line 1769
    iput v7, v1, Landroid/support/v4/app/Fragment;->mBackStackNesting:I
    ...
    invoke-virtual {v3, v5, v6}, Landroid/support/v4/app/FragmentState;->instantiate(Landroid/support/v4/app/FragmentActivity;Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/Fragment;
    ...
    invoke-direct {p0, v5, v0}, Landroid/support/v4/app/FragmentManagerImpl;->setBackStackIndex(ILandroid/support/v4/app/BackStackRecord;)V
...
.method final saveAllState()Landroid/os/Parcelable;
    ...
    invoke-virtual {v4, v10}, Landroid/support/v4/app/Fragment;->performSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-object v9, p0, Landroid/support/v4/app/FragmentManagerImpl;->mStateBundle:Landroid/os/Bundle;
    ...
    invoke-direct {p0, v4}, Landroid/support/v4/app/FragmentManagerImpl;->saveFragmentViewState(Landroid/support/v4/app/Fragment;)V
    ...
    :cond_8
    iget-boolean v10, v4, Landroid/support/v4/app/Fragment;->mUserVisibleHint:Z
    ...
    iget v12, v11, Landroid/support/v4/app/Fragment;->mIndex:I
