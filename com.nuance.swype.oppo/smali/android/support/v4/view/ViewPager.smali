...
.field private mPageTransformer$26346444:Landroid/support/v4/app/FragmentManager$OnBackStackChangedListener;
...
.method private arrowScroll(I)Z
    ...
    invoke-virtual {v9, p0, v1, p1}, Landroid/view/FocusFinder;->findNextFocus(Landroid/view/ViewGroup;Landroid/view/View;I)Landroid/view/View;
    ...
    const-string v11, "arrowScroll tried to find focus based on non-child current focused view "
    ...
    .line 2558
    iget-object v9, p0, Landroid/support/v4/view/ViewPager;->mTempRect:Landroid/graphics/Rect;

    invoke-direct {p0, v9, v4}, Landroid/support/v4/view/ViewPager;->getChildRectInPagerCoordinates(Landroid/graphics/Rect;Landroid/view/View;)Landroid/graphics/Rect;
    ...
    invoke-direct {p0, v9, v1}, Landroid/support/v4/view/ViewPager;->getChildRectInPagerCoordinates(Landroid/graphics/Rect;Landroid/view/View;)Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, v9, v8}, Landroid/support/v4/view/ViewPager;->setCurrentItem(IZ)V
...
.method private onPageScrolled(IFI)V
    ...
    invoke-interface {v10, p1, p2, p3}, Landroid/support/v4/view/ViewPager$OnPageChangeListener;->onPageScrolled(IFI)V
    ...
    .line 1718
    :cond_3
    iget-object v10, p0, Landroid/support/v4/view/ViewPager;->mPageTransformer$26346444:Landroid/support/v4/app/FragmentManager$OnBackStackChangedListener;
...
.method private pageScrolled(I)Z
    ...
    invoke-direct {p0, v7, v8, v7}, Landroid/support/v4/view/ViewPager;->onPageScrolled(IFI)V
    ...
    .line 1650
    invoke-direct {p0, v0, v4, v3}, Landroid/support/v4/view/ViewPager;->onPageScrolled(IFI)V
...
.method private populate(I)V
    ...
    invoke-direct {v0, v1}, Landroid/support/v4/view/ViewPager;->infoForPosition(I)Landroid/support/v4/view/ViewPager$ItemInfo;
    ...
    invoke-direct {v0, v1, v8}, Landroid/support/v4/view/ViewPager;->addNewItem(II)Landroid/support/v4/view/ViewPager$ItemInfo;
    ...
    invoke-direct {v0, v1, v2}, Landroid/support/v4/view/ViewPager;->addNewItem(II)Landroid/support/v4/view/ViewPager$ItemInfo;
    ...
    invoke-direct {v0, v10}, Landroid/support/v4/view/ViewPager;->infoForAnyChild(Landroid/view/View;)Landroid/support/v4/view/ViewPager$ItemInfo;
...
.method private recomputeScrollPosition(IIII)V
    ...
    .end local v10    # "widthWithMargin":I
    :cond_0
    :goto_0
    return-void
...
.method private scrollToItem(IZIZ)V
    ...
    .line 558
    .local v6, "curInfo":Landroid/support/v4/view/ViewPager$ItemInfo;
    const/4 v7, 0x0
    ...
    invoke-virtual {v5, v8}, Landroid/support/v4/view/PagerAdapter;->getPageWidth(I)F
...
.method private setScrollState(I)V
    ...
    .line 393
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mPageTransformer$26346444:Landroid/support/v4/app/FragmentManager$OnBackStackChangedListener;
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    .line 2634
    invoke-direct {p0, v0}, Landroid/support/v4/view/ViewPager;->infoForChild(Landroid/view/View;)Landroid/support/v4/view/ViewPager$ItemInfo;
...
.method final dataSetChanged()V
    ...
    .end local v5    # "lp":Landroid/support/v4/view/ViewPager$LayoutParams;
    :cond_8
    invoke-direct {p0, v7, v10, v9}, Landroid/support/v4/view/ViewPager;->setCurrentItemInternal(IZZ)V
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-direct {p0, v1, v2, v3}, Landroid/support/v4/view/ViewPager;->setCurrentItemInternal(IZZ)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1974
    invoke-direct/range {p0 .. p0}, Landroid/support/v4/view/ViewPager;->requestParentDisallowInterceptTouchEvent$1385ff()V
    ...
    iget v0, v0, Landroid/support/v4/view/ViewPager;->mFlingDistance:I
    ...
    invoke-direct {v0, v12, v1, v2, v10}, Landroid/support/v4/view/ViewPager;->setCurrentItemInternal(IZZI)V
    ...
    .restart local v6    # "activePointerIndex":I
    .restart local v8    # "ii":Landroid/support/v4/view/ViewPager$ItemInfo;
    .restart local v10    # "initialVelocity":I
    .restart local v13    # "pageOffset":F
    .restart local v16    # "scrollX":I
    .restart local v17    # "totalDelta":I
...
.method public setAdapter(Landroid/support/v4/view/PagerAdapter;)V
    ...
    iget-object v7, v1, Landroid/support/v4/view/ViewPager$ItemInfo;->object:Ljava/lang/Object;

    invoke-virtual {v4, p0, v5, v7}, Landroid/support/v4/view/PagerAdapter;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {p0, v5}, Landroid/support/v4/view/ViewPager;->removeViewAt(I)V
    ...
    invoke-direct {v4, p0, v6}, Landroid/support/v4/view/ViewPager$PagerObserver;-><init>(Landroid/support/v4/view/ViewPager;B)V
    ...
    invoke-virtual {v4, v5, v7}, Landroid/support/v4/view/PagerAdapter;->restoreState(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V

    .line 437
    iget v4, p0, Landroid/support/v4/view/ViewPager;->mRestoredCurItem:I

    invoke-direct {p0, v4, v6, v8}, Landroid/support/v4/view/ViewPager;->setCurrentItemInternal(IZZ)V
...
.method public setPageTransformer$382b7817(ZLandroid/support/v4/app/FragmentManager$OnBackStackChangedListener;)V
    .locals 9
    .param p1, "reverseDrawingOrder"    # Z
    .param p2, "transformer"    # Landroid/support/v4/app/FragmentManager$OnBackStackChangedListener;
    ...
    :goto_0
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->mPageTransformer$26346444:Landroid/support/v4/app/FragmentManager$OnBackStackChangedListener;
    ...
    :goto_2
    iput-object p2, p0, Landroid/support/v4/view/ViewPager;->mPageTransformer$26346444:Landroid/support/v4/app/FragmentManager$OnBackStackChangedListener;
    ...
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->mSetChildrenDrawingOrderEnabled:Ljava/lang/reflect/Method;
    ...
    iput-object v4, p0, Landroid/support/v4/view/ViewPager;->mSetChildrenDrawingOrderEnabled:Ljava/lang/reflect/Method;
    :try_end_0
