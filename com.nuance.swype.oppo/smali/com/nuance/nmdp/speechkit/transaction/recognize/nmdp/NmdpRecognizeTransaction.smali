...
.method protected sendParams()V
    ...
    :cond_0
    const-string v2, "binary_results"
    ...
    .line 87
    :pswitch_1
    const-string v2, "intermediate_response_mode"

    const-string v3, "UtteranceDetectionWithCompleteRecognition"

    invoke-interface {v0, v2, v3}, Lcom/nuance/nmsp/client/sdk/components/core/pdx/Dictionary;->addUTF8String(Ljava/lang/String;Ljava/lang/String;)V

    .line 88
    const-string v2, "enable_intermediate_response"
    ...
    .line 92
    const-string v2, "utterance_detection_silence_duration"

    const-string v3, "VeryAggressive"
    ...
    const-string v3, "NoUtteranceDetectionWithPartialRecognition"
