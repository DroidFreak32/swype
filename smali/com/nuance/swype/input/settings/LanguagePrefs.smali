...
.method public buildLanguagesScreen()V
    ...
    .prologue
    .line 55
    iget-object v8, p0, Lcom/nuance/swype/input/settings/LanguagePrefs;->context:Landroid/content/Context;
    ...
    .line 57
    iget-object v9, p0, Lcom/nuance/swype/input/settings/LanguagePrefs;->languageId:Ljava/lang/String;

    invoke-virtual {v8, v9}, Lcom/nuance/swype/input/InputMethods;->findInputLanguage(Ljava/lang/String;)Lcom/nuance/swype/input/InputMethods$Language;
    ...
    const-string v9, "Can\'t find %s in available input languages"
    ...
    iget-object v12, p0, Lcom/nuance/swype/input/settings/LanguagePrefs;->languageId:Ljava/lang/String;
    ...
    .line 62
    :cond_0
    iget-object v8, p0, Lcom/nuance/swype/input/settings/LanguagePrefs;->screen:Landroid/preference/PreferenceScreen;
    ...
    .line 66
    .local v7, "userPrefs":Lcom/nuance/swype/input/UserPreferences;
    ...
    invoke-direct {v0, v8}, Landroid/preference/PreferenceCategory;-><init>(Landroid/content/Context;)V
    ...
    .line 70
    invoke-virtual {v5}, Lcom/nuance/swype/input/InputMethods$Language;->getKoreanInputModes()Ljava/util/List;

    move-result-object v4

    .line 71
    .local v4, "inputModes":Ljava/util/List;, "Ljava/util/List<Lcom/nuance/swype/input/InputMethods$InputMode;>;"
    if-eqz v4, :cond_5
    ...
    invoke-virtual {v7}, Lcom/nuance/swype/input/UserPreferences;->isHandwritingEnabled()Z
    ...
    .line 76
    :cond_2
    invoke-static {v3}, Lcom/nuance/swype/input/settings/InputPrefs;->createArgs(Lcom/nuance/swype/input/InputMethods$InputMode;)Landroid/os/Bundle;
    ...
    invoke-virtual {v3}, Lcom/nuance/swype/input/InputMethods$InputMode;->getEnabledPrefKey()Ljava/lang/String;
    ...
    .end local v4    # "inputModes":Ljava/util/List;, "Ljava/util/List<Lcom/nuance/swype/input/InputMethods$InputMode;>;"
