...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 28
    const-string v0, "KeyboardInputInflater"
...
.method private inflate(I)Landroid/view/View;
    ...
    .prologue
    .line 309
    sget-object v2, Lcom/nuance/swype/input/KeyboardInputInflater;->trace:Lcom/nuance/swype/util/LogManager$Trace;
...
.method public callAllInputViewToDestroy(Z)V
    ...
    .prologue
    .line 91
    sget-object v2, Lcom/nuance/swype/input/KeyboardInputInflater;->log:Lcom/nuance/swype/util/LogManager$Log;

    const-string v3, "#callAllInputViewToDestroy() destroyCore = "
    ...
    invoke-virtual {v2}, Lcom/nuance/swype/input/InputView;->destroy()V
    ...
    invoke-static {v2}, Lcom/nuance/swype/input/KeyboardInputInflater$InputViewHolder;->access$100(Lcom/nuance/swype/input/KeyboardInputInflater$InputViewHolder;)Lcom/nuance/input/swypecorelib/XT9CoreInput;

    move-result-object v2

    invoke-virtual {v2}, Lcom/nuance/input/swypecorelib/XT9CoreInput;->destroySession()V
    ...
    invoke-static {v2}, Lcom/nuance/swype/input/KeyboardInputInflater$InputViewHolder;->access$200(Lcom/nuance/swype/input/KeyboardInputInflater$InputViewHolder;)Lcom/nuance/input/swypecorelib/T9Write;
    ...
    invoke-virtual {v2}, Lcom/nuance/input/swypecorelib/T9Write;->destroySession()V
...
.method public getAllInputViews()Ljava/util/List;
    ...
    .line 84
    .local v2, "lists":Ljava/util/List;, "Ljava/util/List<Lcom/nuance/swype/input/InputView;>;"
    iget-object v3, p0, Lcom/nuance/swype/input/KeyboardInputInflater;->inputViewMap:Ljava/util/Map;
    ...
    check-cast v3, Lcom/nuance/swype/input/KeyboardInputInflater$InputViewHolder;

    invoke-static {v3}, Lcom/nuance/swype/input/KeyboardInputInflater$InputViewHolder;->access$000(Lcom/nuance/swype/input/KeyboardInputInflater$InputViewHolder;)Lcom/nuance/swype/input/InputView;
...
.method public inflateKeyboardInput(Ljava/lang/String;)Landroid/view/View;
    ...
    .line 140
    :cond_1
    const-string v1, "Alpha.KeyboardInput"
    ...
    .line 142
    :cond_2
    const-string v1, "Alpha.HandWriting"
    ...
    .line 146
    :cond_4
    const-string v1, "Chinese.HandWriting"
    ...
    .line 148
    :cond_5
    const-string v1, "Chinesefs.handwriting"
    ...
    .line 152
    :cond_7
    const-string v1, "Korean.HandWriting"
    ...
    .line 154
    :cond_8
    const-string v1, "Japanese.Input"
    ...
    .line 156
    :cond_9
    const-string v1, "Japanese.HandWriting"
    ...
    const-string v3, " is not a valid input view name"
